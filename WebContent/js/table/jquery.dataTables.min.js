...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Procesando...",sLengthMenu:"Mostrar _MENU_ resultados",sZeroRecords:"No se encontraron resultados",sEmptyTable:"No hay entradas disponibles en la tabla",
sLoadingRecords:"Procesando...",sInfo:" _START_ de _END_ en _TOTAL_ resultados",sInfoEmpty:"0 de 0 en 0 resultados",sInfoFiltered:"(filtrado de un total de _MAX_ resultados)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primera",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Última"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
